          ...
          <div className="flex flex-col md:flex-row md:-mx-4">
            <div className="flex-1 order-2 md:order-1 md:mx-4">
              ...
              <p className="mb-3">
                ...
                of their space. A space where you want to spend time because you
                feel comfortable and make you feel emotions. I want to help you
                implement the ideas in your head into something tangible. Help
                you express your personality and what you really like.
              </p>
              <p className="mb-3">
                ...
                indie startup called ‘Spoak’ where we helped clients achieve
                their dream space.
              </p>
              <p className="">
